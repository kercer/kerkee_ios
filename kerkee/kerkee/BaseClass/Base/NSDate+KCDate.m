...
{
    return ABS([self secondsBeforeDate:aDate]);
}
...
{
    return ABS([self minutesBeforeDate:aDate]);
}
...
{
    return abs([self hoursBeforeDate:aDate]);
}
...
{
    return ABS([self daysBeforeDate:aDate]);
}
